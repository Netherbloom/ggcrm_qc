...
import com.ggcrm.core.util.FastDate;
...
public class DateTimeUtil {
	...
	public static String getCurrentTime(){
		return StringUtil.toString(System.currentTimeMillis());
	}
	...
	public static String getTime(String parrten) {
	 ...
	 public static boolean compareSignDate(String signDate, int checktime) throws Exception{
	    	boolean isOk = false;
	    	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	    	signDate = sdf.format(DateTimeUtil.dateAdd(sdf.parse(signDate), "m", checktime));//签名有效时间
	    	String currentDate = sdf.format(new Date());
	    	if(signDate.compareTo(currentDate) > 0){
	    		isOk = true;
	    	}
	    	return isOk;
	    }
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * System.out.println(DateTimeUtil.formatDateTime(DateTimeUtil.getDate(
		 * "2013-12"), "yyyy-MM"));
		 * System.out.println(DateTimeUtil.formatDateTime
		 * (DateTimeUtil.addMonth(DateTimeUtil.getDate("2013-12"), 1),
		 * "yyyy-MM")); //System.out.println(DateTimeUtil.formatStatDate(3800));
		 * //System.out.println(DateTimeUtil.formatStatDate(15254235));
		 */
		// long l = DateTimeUtil.getInterval(DateTimeUtil.getDate("2013-02-01"),
		// DateTimeUtil.getDate("2013-01-01"));

		//long l = DateTimeUtil.getInterval("2014-05-15", "2014-05-11");
          
		//System.out.println(l);
		System.out.println(DateTimeUtil.parseDate(new FastDate().toText(), "yyyy-MM-dd HH:mm:ss"));
		System.out.println(compareSignDate("2016-10-17 12:09",60));
		// System.out.println(DateTimeUtil.getDayOfMonth(DateTimeUtil.getDate("2013-01-01")));
		// System.out.println(DateTimeUtil.getDatesBetween(DateTimeUtil.getDate("2013-01-01"),DateTimeUtil.getDate("2013-02-01")).toString());
	}
